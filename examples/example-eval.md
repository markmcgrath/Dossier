...
**Strong alignment:**
- 9 years building data platforms at scale (current role: Platform Lead at logistics fintech) translates directly to "design and build internal platform infrastructure"
- Hands-on Snowflake + dbt experience from previous role (retail analytics SaaS); current role includes Spark cluster optimization and warehouse cost management
- Multi-tenant data governance and role-based access control (RLS) from fintech compliance environment — directly applicable to Cipher's multi-tenant SaaS architecture
- Cross-functional collaboration with analytics, ML, and backend engineering teams is core to the platform engineer profile
...
**Right level.** Senior (not Staff) in a 6-person team is appropriate for someone with 9 years of platform engineering experience. Comp ceiling ($240K) is realistic for senior IC in data infrastructure at Series B. No over- or under-leveling concern. Potential for Staff-level growth within 2–3 years if company scales.
...
|---|-----------|-------|--------|--------------|
| 1 | Role & Responsibility Match | 4.5 | 20% | 0.90 |
| 2 | Skills & Experience Alignment | 4.0 | 20% | 0.80 |
| 3 | Seniority & Level Fit | 4.0 | 10% | 0.40 |
| 4 | Compensation vs. Market | 4.0 | 10% | 0.40 |
| 5 | Growth & Advancement Potential | 4.0 | 10% | 0.40 |
| 6 | Company Strength & Stability | 3.5 | 10% | 0.35 |
| 7 | Culture & Values Signals | 3.5 | 8% | 0.28 |
| 8 | Remote / Location Fit | 5.0 | 5% | 0.25 |
| 9 | Hiring Signal Quality | 4.0 | 4% | 0.16 |
| 10 | Strategic Career Value | 4.0 | 3% | 0.12 |
| | **Weighted Total** | | | **4.06** |

*Note: Dimension 6 and 7 reflect Series B execution and culture verification risk. If culture due diligence in first screen is positive, both could rise to 4.0–4.5, pushing overall score to 4.25+.*
...
This evaluation is based on JD analysis and market comparables. It does not account for:
- Actual manager fit (unknown; recommend reference check if offer stage)
- Internal org changes or attrition history (would require insider data)
- Undisclosed product roadmap changes that could affect team scope
