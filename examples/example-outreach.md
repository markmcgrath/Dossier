...
**Recipient:** [Hiring Manager Name], VP Engineering at Cipher Analytics  
**Copy:** (150 words, conversational tone)
...
**To:** [hiring.manager@cipheranalytics.com](mailto:hiring.manager@cipheranalytics.com)  
**Subject:** Data Platform Eng at Cipher Analytics
...
- **Response rate goal:** 30–40% on warm intros (via LinkedIn after profile review), 10–15% on cold email
- **If replied:** Use first response to ask specific questions about team dynamics, product roadmap, and growth expectations (see `example-prep.md` for a list of good follow-up questions)
- **If no response after 2 touches:** Archive this outreach (they're not interested or too busy). Don't follow up a third time.
