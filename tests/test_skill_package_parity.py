...
# Entries generated by .github/scripts/build_skill.sh that have no on-disk
# source counterpart under skill/. These are excluded from parity checks.
GENERATED_ENTRIES = frozenset({"skill/manifest.json"})
...
def test_zip_entries_match_source_files(skill_zip, vault_path):
    ...
    for name in skill_zip.namelist():
        ...
        if name in GENERATED_ENTRIES:
            continue  # generated by the packer, no source counterpart
